  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>, type: 'banner' | 'logo') => {
    ...
    try {
      ...
      const {
        error: uploadError,
        data
      } = await supabase.storage.from('church-assets').upload(fileName, file);
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="container max-w-6xl py-8">
          <Card className="mb-8 overflow-hidden relative">
            <div className="h-48 bg-gradient-to-r from-blue-500 to-purple-600 relative" style={church.bannerImage ? {
            ...
            <div className="p-6 -mt-16">
              <div className="bg-white rounded-lg p-6 shadow-lg py-[71px]">
                <div className="flex justify-between items-start">
                  ...
                  {church.logoImage && <div className="w-24 h-24 rounded-full overflow-hidden">
            ...
            <DialogContent className="sm:max-w-[600px]">
              ...
              <form onSubmit={handleSave} className="space-y-4">
                <div>
                  ...
                  <Input value={church.name} onChange={e => setChurch({
                  ...church,
                  name: e.target.value
                })} required />
                </div>
                <div>
                  ...
                  <Textarea value={church.description} onChange={e => setChurch({
                  ...church,
                ...
                <div>
                  ...
                  <Textarea value={church.missionStatement} onChange={e => setChurch({
                  ...church,
                ...
                <div>
                  ...
                  <Input value={church.location} onChange={e => setChurch({
                  ...church,
                ...
                <div>
                  ...
                  <Input type="email" value={church.contactEmail} onChange={e => setChurch({
                  ...church,
                ...
                <div>
                  ...
                  <Input value={church.contactPhone} onChange={e => setChurch({
                  ...church,
                ...
                <div>
                  ...
                  <Input type="url" value={church.websiteUrl} onChange={e => setChurch({
                  ...church,
            ...
            <TabsContent value="about">
              <Card className="p-6">
                ...
                <div className="space-y-3">
                  {church.serviceTimes.map((service, index) => <div key={index} className="flex justify-between items-center border-b pb-2">
                      <div>
