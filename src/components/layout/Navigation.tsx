      ...
      <div className="container max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2">
            <span className="text-sky-600 font-extrabold text-2xl text-left">
              Adventist.com
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            {user ? <Button onClick={handleSignOut} variant="default" className="bg-social-primary hover:bg-social-secondary">
                <LogOut className="w-4 h-4 mr-2" />
                Sign Out
              </Button> : <Button asChild variant="default" className="bg-social-primary hover:bg-social-secondary">
                <Link to="/auth">
          ...
          <div className="md:hidden">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                {user ? <DropdownMenuItem onClick={handleSignOut} className="flex items-center gap-2">
